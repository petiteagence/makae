...
items:
	makaevents1:
		size: "8"
		titre: "Une offre adaptée à votre besoin, ou faire de l'événementiel utile"
		texte: "L'organisation de séminaires, apéritifs, petits déjeuners, soirées d'entreprises, [...] pour motiver, remercier, challenger, fédérer, réunir, communiquer, auprès de vos salariés et de vos clients. [saut] Pour les petites et moyennes entreprises qui veulent une relation différente et efficace avec l'événementiel."
		liste: [
	...
	makaevents2:
		size: "8"
		titre: "Les forfaits Forma'zen pour une solution adaptée à chacun"
		...
		liste: [
			...
			"Nous proposons des forfaits en nombre de jours ou nombre de formations, adaptés selons vos besoins.",
		]

	makaevents3:
		size: "8"
		titre: "La réussite de l'événement commence par le brief"
		texte: "Ensemble, nous étudions vos besoins, votre situation, vos attentes, votre contexte qui feront que votre événement sera différent de tous les autres. [saut] A qui est destiné l'événement ? Pourquoi investir ? Quel ROI attendez-vous ? Quel est l'effet attendu ?"
	...
	makaepop1:
		size: "8"
		titre: "Le digital-to-store : la vente en pop up store"
		texte: "Nous proposons de vous accompagner pour vous permettre de vous lancer en boutique physique. Nous chercherons la solution qui s'adapte à vos produits. [saut] Le pop up store est une solution simple et personnalisable pour une communication et une vente ciblée (localisation, promotion, ...)"
	...
	makaepop3:
		...
		texte: "1 - Nous échangeons avec vous pour définir le type d’opération souhaitée, [saut][saut] 2 - Nous cherchons le lieu, le concept et l'aménagement possibles avec des équipes d’architectes, et proposons tous les services jusqu'à l'animation du magasin par des équipes de vente, [saut][saut] 3 - Enfin, nous aidons à la conception de solutions pour animer et faire connaître le lancement."
